...
SRC = ROOT / "data/processed/cooper_mo/cooper_parcels_for_supabase.ndjson"
...
def main():
    delete_url = SUPABASE_URL.rstrip("/") + "/rest/v1/parcels?source_dataset=eq.cooper-mo-20260405"
